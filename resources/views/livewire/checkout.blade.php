<div class="container">
    ...
    <div class="row">
        <div class="col">
            <a href="{{ route('keranjang') }}" class="btn btn-sm btn-danger">
    ...
    <div class="row mt-4">
        <div class="col">
            ...
            <div class="media mt-3">
                <img class="mr-3" src="{{ asset('assets/slider/bank.png') }}" alt="Bank BRI" width="60">
                <div class="media-body">
                    <h5 class="mt-0">Link Bank</h5>
                    <details>No. Rekening
                        <aside>0000-1111-2901</aside>
                        <aside>Atas Nama</aside>
