                    ...
                    <form wire:submit.prevent="masukkanKeranjang">
                        <table class="table" style="border-top : hidden">
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <img src="{{ asset('assets/liga') }}/{{ $product->liga->gambar}}" class="img-fluid"
                                        width="50">
                                    <h6>{{ $product->liga->nama }}</h6>
                                </td>
                            </tr>
                            <tr>
                                <td>Jenis</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="nomor" type="number"
                                        ...
                                        value="{{ old('nomor') }}" autocomplete="name" autofocus>
                            ...
                            <tr>
                                <td colspan="3">
                                    <button type="submit" class="btn btn-success btn-block" @if($product->is_ready !==
                                        1)
                                        disabled
