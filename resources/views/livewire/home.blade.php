...
<div class="container">
    {{-- BANNER --}}
    <div class="banner">
        <img src="{{ asset('assets/slider/slide.png') }}" alt="">
    </div>
            ...
            <div class="col">
                ...
                <div class="card shadow">
                    <div class="card-body text-center">
                        <img src="{{ asset('assets/liga/'. $liga->gambar) }}
                        " class="img-fluid">
                    </div>
                </div>
                </a>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12">
                            <a href="{{ route('products.detail', $product->id) }}" class="btn btn-dark
                                btn-block"><i class="fas fa-eye"></i> Detail</a>
                        </div>
                    </div>
                </div>
            </div>
